...
if __name__ == "__main__":
    conf = json.load(open(r"C:\Python\Python_data\Scripts\PROGRAMMING_Iot\PROJECT\Telegram\settings_warning.json"))
    token = conf["telegramToken"]
    service_catalog_info=(r"C:\Python\Python_data\Scripts\PROGRAMMING_Iot\PROJECT\Telegram\service_catalog_info.json")
    bot=EchoBot1(token,service_catalog_info,r"C:\Python\Python_data\Scripts\PROGRAMMING_Iot\PROJECT\Telegram\health_limits.json")
