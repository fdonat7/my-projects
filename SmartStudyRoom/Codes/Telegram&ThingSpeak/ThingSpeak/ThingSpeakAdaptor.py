...
import datetime
import requests
think = json.load(open(r"C:\Python\Python_data\Scripts\PROGRAMMING_Iot\PROJECT\ThingSpeak\config.json"))
class ThinkSpeak:
...
if __name__ == "__main__":
    ...
    service_catalog_info=json.load(open(r"C:\Python\Python_data\Scripts\PROGRAMMING_Iot\PROJECT\Telegram\service_catalog_info.json"))
    ...
    tp = ThinkSpeak("SmartStudyRoom22714",think["broker"],1883)
